...
export const corporateExperience: ExperienceItem[] = [
  ...
  },
  {
    ...
    achievements: [
      ...
      'Implementei gestão ágil de alto impacto, diminuindo backlog de chamados de 52 para menos de 10 e reduzindo o SLA de 7 para 3 dias, por meio de métricas claras e priorização eficiente.',
      'Acelerei auditorias internas em 40%, estabelecendo padrões de comunicação e governança que aumentaram transparência e confiabilidade.',
  ...
  },
  {
    ...
    type: 'concluido',
    achievements: [
      'Ao longo de quase 10 anos na i4Pro, atuei em diferentes funções que marcaram minha evolução de especialista técnico para liderança de projetos e contas estratégicas no setor de seguros, capitalização e previdência.',
      ...
      'Como Gerente de Projetos (2015–2017), assumi a liderança da equipe de Capitalização em cenário crítico, revertendo risco de perda de cliente. Implementei monitoramento de incidentes e KPIs semanais, reduzindo o tempo de resposta em 60%. Garanti entregas end-to-end dentro do prazo, assegurando excelência operacional e reduzindo retrabalho em 60% por meio de treinamentos técnicos e de negócio.',
      'Como Gerente de Contas (2017–2021), liderei a recuperação da conta InvestPrev/Kovr Seguros em um momento de crise de confiança. Os resultados incluíram +49% de faturamento em 5 meses, –65% de incidentes reportados e expansão de 72% no contrato, tornando a conta uma das 3 mais rentáveis da empresa. Também implementei automação de fluxos e dashboards em tempo real (Power BI/Excel), reduzindo prazos de atendimento de 14 para 4 dias úteis e acelerando decisões em 40%.',
    ],
  },
];
