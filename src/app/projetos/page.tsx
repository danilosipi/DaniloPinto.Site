...
export const metadata: Metadata = {
  ...
  description:
    'Conheça os projetos de transformação digital, automação e engenharia de software liderados por Danilo Pinto.',
    ...
    <div className="bg-background">
      <Container className="space-y-12 py-16">
        <header className="max-w-3xl space-y-4">
          <h1 className="text-4xl font-semibold text-default">Projetos</h1>
          <p className="text-lg text-soft">
            Iniciativas e estudos de caso em transformação digital, automação e cultura de
            engenharia. Cada projeto representa um desafio de negócio e uma solução técnica
            aplicada.
          </p>
        </header>
